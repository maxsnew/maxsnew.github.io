...
(function(exports) {
  ...
  var parseBool = (function () {
      ...
      return Data_Argonaut_Core.foldJsonNumber(expected("boolean"))(function ($43) {
          return Control_Applicative.pure(Data_Either.applicativeEither)(numToBool($43));
      });
  })();
  ...
  var ui = (function () {
      var render = function (st) {
          ...
          if (st instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(Data_Show.show(Data_Either.showEither(Data_Show.showString)(Data_Show.showArray(GBFS.showNTStationStatus)))(Data_Functor.map(Data_Either.functorEither)(Data_Functor.map(Data_Functor.functorArray)(GBFS.NTStationStatus))(st.value0.stationStatuses))) ]);
          };
          throw new Error("Failed pattern match at App line 48, column 7 - line 51, column 89: " + [ st.constructor.name ]);
      };
      ...
      var getParse = function (parser) {
          return function (url) {
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)(infoUrl))(function (v) {
