...
var simpleSlot = function (addr) {
    return function (c) {
        return Halogen_HTML.slot(addr)(c)(Data_Unit.unit)(Data_Void.absurd);
    };
};
...
var ui = (function () {
    var render = function (st) {
        ...
        if (st instanceof HWData) {
            return Halogen_HTML_Elements.div_([ refreshButton, Halogen_HTML_Core.text("Last updated: " + Data_Show.show(Data_Time.showTime)(st.value1)), simpleSlot(HOME.value)(StationTable.stationTable({
                place: Common.home, 
                stations: st.value0, 
                initLimit: 7
            })), simpleSlot(WORK.value)(StationTable.stationTable({
                place: Common.work, 
                stations: st.value0, 
                initLimit: 6
            })) ]);
        };
        throw new Error("Failed pattern match at App line 68, column 7 - line 76, column 20: " + [ st.constructor.name ]);
    };
    var $$eval = function (v) {
        return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(getParse(GBFS.parseStationInfos)(Common.infoUrl)))(function (v1) {
            return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(getParse(GBFS.parseStationStatuses)(Common.statusUrl)))(function (v2) {
                ...
                throw new Error("Failed pattern match at App line 83, column 7 - line 89, column 20: " + [ v3.constructor.name ]);
            });
        });
    };
