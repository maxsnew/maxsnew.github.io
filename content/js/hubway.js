...
(function(exports) {
  ...
  var parseBool = (function () {
      ...
      return Data_Argonaut_Core.foldJsonNumber(expected("boolean"))(function ($20) {
          return Control_Applicative.pure(Data_Either.applicativeEither)(numToBool($20));
      });
  })();
  ...
  var parseStationStatus = Data_Argonaut_Core.foldJsonObject(new Data_Either.Left("Expected StationStatus"))(function (smap) {
      ...
      })(Control_Bind.bindFlipped(Data_Either.bindEither)(parseStr)(lookupExpect("station_id")(smap))))(Control_Bind.bindFlipped(Data_Either.bindEither)(parseNumber)(lookupExpect("num_bikes_available")(smap))))(Control_Bind.bindFlipped(Data_Either.bindEither)(parseNumber)(lookupExpect("num_docks_available")(smap))))(Control_Bind.bindFlipped(Data_Either.bindEither)(parseBool)(lookupExpect("is_renting")(smap))))(Control_Bind.bindFlipped(Data_Either.bindEither)(parseBool)(lookupExpect("is_installed")(smap))))(Control_Bind.bindFlipped(Data_Either.bindEither)(parseBool)(lookupExpect("is_returning")(smap))))(Control_Bind.bindFlipped(Data_Either.bindEither)(parseNumber)(lookupExpect("last_reported")(smap)));
  });
  var parseStationStatuses = function (js) {
      var expectedObject = new Data_Either.Left("Expected Object with staitons field of StationStatuses");
      var expectedArray = new Data_Either.Left("Expected Array of StationStatuses");
      return Control_Bind.bind(Data_Either.bindEither)(parseGbfs(js))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Core.foldJsonObject(expectedObject)(lookupExpect("stations"))(v["data'"]))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Core.foldJsonArray(expectedArray)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(parseStationStatus))(v1))(function (v2) {
...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (st) {
          if (st.hubwayData instanceof Data_Either.Left) {
              return Halogen_HTML_Core.text(st.hubwayData.value0);
          };
          if (st.hubwayData instanceof Data_Either.Right) {
              return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showArray(Data_Show.showString))(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  return v.station_id;
              })(st["hubwayData"]["value0"]["data'"]))) ]);
          };
          throw new Error("Failed pattern match at App line 46, column 7 - line 50, column 67: " + [ st.hubwayData.constructor.name ]);
      };
      var parseResponse = function (s) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Parser.jsonParser(s))(function (v) {
              return GBFS.parseStationStatuses(v);
          });
      };
      var initialState = function (s) {
          return {
              hubwayData: new Data_Either.Left("loading...")
          };
      };
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)(statusUrl)))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $11.hubwayData = parseResponse(v1.response);
                  return $11;
              }))(function () {
