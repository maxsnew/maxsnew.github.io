...
(function(exports) {
  ...
  var renderStation = function (s) {
      return Halogen_HTML_Elements.tr_(Data_Functor.map(Data_Functor.functorArray)(function ($23) {
          return Halogen_HTML_Elements.td_(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Core.text($23)));
  ...
  var mergeHWData = function (is) {
      ...
      var findStatus = function (status) {
          ...
          throw new Error("Failed pattern match at App line 122, column 25 - line 124, column 54: " + [ v.constructor.name ]);
      };
  ...
  var header = Halogen_HTML_Elements.thead_([ Halogen_HTML_Elements.tr_(Data_Functor.map(Data_Functor.functorArray)(function ($24) {
      return Halogen_HTML_Elements.th_(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Core.text($24)));
  })([ "Station", "Bikes", "Vacancies" ])) ]);
  var renderNearPlace = function (hwData) {
      return function (place) {
          var nearbyData = Data_Array.take(6)(Data_Array.sortWith(Data_Ord.ordNumber)(function (dat) {
              return proximity(place)(dat.info);
          })(hwData));
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Places near " + place.name) ]), Halogen_HTML_Elements.table_([ header, renderData(nearbyData) ]) ]);
      };
  };
  var ui = (function () {
      var render = function (st) {
          ...
          if (st instanceof Data_Maybe.Just) {
              ...
              if (v instanceof Data_Either.Right) {
                  ...
                  return Halogen_HTML_Elements.div_([ renderNearPlace(hwData)(home), renderNearPlace(hwData)(work) ]);
              };
              throw new Error("Failed pattern match at App line 63, column 11 - line 67, column 86: " + [ v.constructor.name ]);
          };
          throw new Error("Failed pattern match at App line 60, column 7 - line 67, column 86: " + [ st.constructor.name ]);
      };
