...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (st) {
          if (st.hubwayData instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.body([ Halogen_HTML_Events.onLoad(Halogen_HTML_Events.input_(MakeRequest.create(statusUrl))) ])([ Halogen_HTML_Core.text("Loading...") ]);
          };
          if (st.hubwayData instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(st.hubwayData.value0) ]);
          };
          throw new Error("Failed pattern match at App line 49, column 7 - line 54, column 33: " + [ st.hubwayData.constructor.name ]);
      };
      var mkButton = function (s) {
          return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title(s), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(MakeRequest.create(s))) ])([ Halogen_HTML_Core.text(s) ]);
      };
      var initialState = function (s) {
          return {
              hubwayData: Data_Maybe.Nothing.value
          };
      };
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)(v.value0)))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  var $7 = {};
                  for (var $8 in v2) {
                      if ({}.hasOwnProperty.call(v2, $8)) {
                          $7[$8] = v2[$8];
                      };
                  };
                  $7.hubwayData = new Data_Maybe.Just(v1.response);
                  return $7;
              }))(function () {
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(App.ui)("")(v))(function (v1) {
          return v1.query(Halogen_Query.action(App.MakeRequest.create(App.statusUrl)));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
