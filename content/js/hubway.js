...
(function(exports) {
  ...
  var genericNTStationStatus = new Data_Generic.Generic(function (v) {
      ...
      return new Data_Generic.SProd("GBFS.NTStationStatus", [ function ($dollarq) {
          return new Data_Generic.SRecord([ {
              ...
              recLabel: "num_bikes_available", 
              recValue: function ($dollarq1) {
                  return Data_Generic.toSpine(Data_Generic.genericNumber)(v.num_bikes_available);
              }
          }, {
              recLabel: "num_docks_available", 
              recValue: function ($dollarq1) {
                  return Data_Generic.toSpine(Data_Generic.genericNumber)(v.num_docks_available);
              }
          }, {
              recLabel: "station_id", 
              recValue: function ($dollarq1) {
  ...
  var parseBool = (function () {
      ...
      return Data_Argonaut_Core.foldJsonNumber(expected("boolean"))(function ($59) {
          return Control_Applicative.pure(Data_Either.applicativeEither)(numToBool($59));
      });
  })();
  ...
  exports["NTStationInformation"] = NTStationInformation;
  exports["NTStationStatus"] = NTStationStatus;
  ...
  exports["genericNTStationStatus"] = genericNTStationStatus;
  exports["showNTStationStatus"] = showNTStationStatus;
  exports["genericNTStationInformation"] = genericNTStationInformation;
  exports["showNTStationInformation"] = showNTStationInformation;
})(PS["GBFS"] = PS["GBFS"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  ...
  var ui = (function () {
      var render = function (st) {
          ...
          if (st instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(Data_Show.show(Data_Either.showEither(Data_Show.showString)(Data_Show.showArray(GBFS.showNTStationStatus)))(Data_Functor.map(Data_Either.functorEither)(Data_Functor.map(Data_Functor.functorArray)(GBFS.NTStationStatus))(st.value0.stationStatuses))), Halogen_HTML_Core.text(Data_Show.show(Data_Either.showEither(Data_Show.showString)(Data_Show.showArray(GBFS.showNTStationInformation)))(Data_Functor.map(Data_Either.functorEither)(Data_Functor.map(Data_Functor.functorArray)(GBFS.NTStationInformation))(st.value0.stationInfos))) ]);
          };
          throw new Error("Failed pattern match at App line 52, column 7 - line 57, column 20: " + [ st.constructor.name ]);
      };
