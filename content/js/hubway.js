...
(function(exports) {
  ...
  var renderStation = function (s) {
      return Halogen_HTML_Elements.tr_(Data_Functor.map(Data_Functor.functorArray)(function ($4) {
          return Halogen_HTML_Elements.td_(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Core.text($4)));
  ...
  var header = Halogen_HTML_Elements.thead_([ Halogen_HTML_Elements.tr_(Data_Functor.map(Data_Functor.functorArray)(function ($5) {
      return Halogen_HTML_Elements.th_(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Core.text($5)));
  ...
  var stationTable = (function () {
      var render = function (st) {
          ...
          var nearbyStations = Data_Array.take(6)(Data_Array.sortWith(Data_Ord.ordNumber)(proximityToPlace)(st.stations));
      ...
      var render = function (st) {
          ...
          if (st instanceof Data_Maybe.Just) {
              ...
              if (v instanceof Data_Either.Right) {
                  ...
                  return Halogen_HTML_Elements.div_([ Halogen_HTML.slot(HOME.value)(StationTable.stationTable)({
                      place: Common.home, 
                      stations: hwData
                  })(Data_Void.absurd), Halogen_HTML.slot(WORK.value)(StationTable.stationTable)({
                      place: Common.work, 
                      stations: hwData
                  })(Data_Void.absurd) ]);
              };
