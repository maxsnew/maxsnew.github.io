...
(function(exports) {
  ...
  var renderStation = function (s) {
      return Halogen_HTML_Elements.tr_(Data_Functor.map(Data_Functor.functorArray)(function ($6) {
          return Halogen_HTML_Elements.td_(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Core.text($6)));
  ...
  var header = Halogen_HTML_Elements.thead_([ Halogen_HTML_Elements.tr_(Data_Functor.map(Data_Functor.functorArray)(function ($7) {
      return Halogen_HTML_Elements.th_(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Core.text($7)));
  ...
  var stationTable = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at StationTable line 65, column 10 - line 75, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var mergeHWData = function (is) {
      ...
      var findStatus = function (status) {
          ...
          throw new Error("Failed pattern match at App line 105, column 25 - line 107, column 53: " + [ v.constructor.name ]);
      };
