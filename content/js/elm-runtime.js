...
Elm.Dict.make = function (_elm) {
   ...
   var lookup = F2(function (k,t) {
      return function () {
         ...
         {case "RBEmpty":
            ...
            case "RBNode":
            return function () {
                 var _v93 = A2(Native.Utils.compare,
                 k,
                 t._1);
                 switch (_v93.ctor)
                 {case "EQ":
   ...
   var blackish = function (_v156) {
      return function () {
         switch (_v156.ctor)
         {case "RBNode":
            return _N.eq(_v156._0,
              Black) || _N.eq(_v156._0,
              BBlack);}
         _E.Case($moduleName,
         "on line 260, column 31 to 56");
      }();
   };
...
Elm.Graphics.Collage.make = function (_elm) {
   ...
   var scale = F2(function (s,f) {
      return _N.replace([["scale"
                         ,f.scale * s]],
      f);
   });
   var rotate = F2(function (t,f) {
      return _N.replace([["theta"
                         ,f.theta + t]],
      f);
   });
...
Elm.Graphics.Element.make = function (_elm) {
   ...
   var midLeft = _N.replace([["horizontal"
                             ,N]
                            ,["x",Absolute(0)]],
   middle);
   var midRight = _N.replace([["horizontal"
                              ,P]],
   midLeft);
   var midTop = _N.replace([["vertical"
                            ,P]
                           ,["y",Absolute(0)]],
   middle);
   var midBottom = _N.replace([["vertical"
                               ,N]],
   midTop);
   var topLeft = {_: {}
                 ,horizontal: N
                 ...
                 ,x: Absolute(0)
                 ,y: Absolute(0)};
   var bottomLeft = _N.replace([["vertical"
                                ,N]],
   topLeft);
   var bottomRight = _N.replace([["horizontal"
                                 ,P]],
   bottomLeft);
   var topRight = _N.replace([["horizontal"
                              ,P]],
   topLeft);
